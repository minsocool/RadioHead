    ...
    <SafeAreaView // FULL SCREEN 100%
      ...
      <ScrollView>
        ...
        <View // Bottom Screen 10%
          ...
          <ScrollView>
            <View // full scroll view PlayLists
              style={{
                // 1st Playlists
                flex: 1, // full  list view
                flexDirection: 'column',
              }}>
              <View // play list Liked Song
                style={{
                  flexDirection: 'row',
                  marginVertical: 5,
                }}>
                <Image
                  source={images.justinBieber}
                  style={{
                    width: 44,
                    height: 44,
                    borderRadius: 400 / 2,
